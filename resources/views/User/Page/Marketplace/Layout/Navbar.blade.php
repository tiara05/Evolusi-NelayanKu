...
<header id="header" class="fixed-top">
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <h1 class="logo"><a href="{{route('marketplace.index')}}"><img src="{{asset('Logo.png')}}" class="img-fluit" alt=""></a></h1>
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="nav-link scrollto" href="">Pre Order</a></li>
          ...
          <li><a class="nav-link scrollto o" href="{{route('account.index')}}">Account</a></li>
